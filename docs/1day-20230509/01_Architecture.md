...
<figure markdown style="border: 1px solid #000">
  ![Slide LUMI is...](img/LUMI-1day-20230509-architecture/Dia2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide The AMD EPYC 7xx3 (Milan/Zen3) CPU](img/LUMI-1day-20230509-architecture/Dia3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide The AMD EPYC 7xx3 (Milan/Zen3) CPU (2)](img/LUMI-1day-20230509-architecture/Dia4.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide LUMI-C node](img/LUMI-1day-20230509-architecture/Dia5.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Strong hierarchy](img/LUMI-1day-20230509-architecture/Dia6.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Delays in numbers](img/LUMI-1day-20230509-architecture/Dia7.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Concept LUMI-G node](img/LUMI-1day-20230509-architecture/Dia8.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Real LUMI-G node](img/LUMI-1day-20230509-architecture/Dia9.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide The future we're preparing for...](img/LUMI-1day-20230509-architecture/Dia10.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Slingshot interconnect](img/LUMI-1day-20230509-architecture/Dia11.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide HPE Cray EX System](img/LUMI-1day-20230509-architecture/Dia12.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide LUMI](img/LUMI-1day-20230509-architecture/Dia13.png){ loading=lazy }
</figure>
