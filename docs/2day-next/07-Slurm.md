...
<!--
<figure markdown style="border: 1px solid #000">
  ![Slide Partitions allocatable per node](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/PartitionsPerNode.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Partitions allocatable by resources](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/PartitionsByResources.png){ loading=lazy }
</figure>
-->
...
1.  **"Per-node allocations":** Request suitable nodes (number of nodes and partition) with `sbatch` or `salloc`
    ...
    MPI ranks. This will be the topic of the [next chapter of the course](07-Binding.md) and is for some applications very important
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job environment](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/JobEnvironment.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Passing arguments](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/PassingArguments.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Automatic requeueing](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/AutomaticRequeueing.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job dependencies](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/JobDependencies.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Interactive jobs with salloc](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/JobInteractiveSalloc.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Interactive jobs with srun](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/JobInteractiveSrun.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Inpecting a running job](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/JobInteractiveAttach.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job arrays](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/JobArrays.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Heterogeneous jobs](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/HeterogeneousJobs.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Heterogeneous jobs: Example with #SBATCH](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/HeterogeneousJobsExampleSBATCH.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Heterogeneous jobs: Example with srun](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/HeterogeneousJobsExampleSrun.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Simultaneous job steps](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/SimultaneousJobSteps.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job monitoring with sstat 1](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/MonitoringSstat_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Job monitoring with sstat 2](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/MonitoringSstat_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information with sacct 1](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/MonitoringSacct_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information with sacct 2](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/MonitoringSacct_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information with sacct 3](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/MonitoringSacct_3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information from sreport](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-07-Slurm/MonitoringSreport.png){ loading=lazy }
</figure>
