...
<!--
<figure markdown style="border: 1px solid #000">
  ![Slide Partitions allocatable per node](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/PartitionsPerNode.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Partitions allocatable by resources](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/PartitionsByResources.png){ loading=lazy }
</figure>
-->
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job environment](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/JobEnvironment.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Passing arguments](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/PassingArguments.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Automatic requeueing](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/AutomaticRequeueing.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job dependencies](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/JobDependencies.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Interactive jobs with salloc](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/JobInteractiveSalloc.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Interactive jobs with srun](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/JobInteractiveSrun.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Inpecting a running job](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/JobInteractiveAttach.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job arrays](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/JobArrays.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Heterogeneous jobs](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/HeterogeneousJobs.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Heterogeneous jobs: Example with #SBATCH](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/HeterogeneousJobsExampleSBATCH.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Heterogeneous jobs: Example with srun](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/HeterogeneousJobsExampleSrun.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Slurm multi-prog](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/Multiprog.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Simultaneous job steps](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/SimultaneousJobSteps.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job monitoring with sstat 1](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/MonitoringSstat_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Job monitoring with sstat 2](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/MonitoringSstat_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information with sacct 1](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/MonitoringSacct_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information with sacct 2](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/MonitoringSacct_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information with sacct 3](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/MonitoringSacct_3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Job information from sreport](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-201-Slurm/MonitoringSreport.png){ loading=lazy }
</figure>
