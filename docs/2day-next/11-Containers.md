...
<figure markdown style="border: 1px solid #000">
  ![Environment enhancements (3)](https://462000265.lumidata.eu/2day-next/img/LUMI-2day-next-11-Containers/ContainersEnvironmentEnhancement_3.png){ loading=lazy }
</figure>
...
-   We also use a 
    ...
    We use the
    ["Linear assignment of GCD, then match the cores" strategy](http://localhost:8000/LUMI-training-materials/2day-next/08-Binding/#linear-assignment-of-gcd-then-match-the-cores).
