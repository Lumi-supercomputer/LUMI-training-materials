...
<figure markdown style="border: 1px solid #000">
  ![Slide What are we talking about](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/WhatAbout.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide When/where is it done](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/WhenDone.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Why do I need this](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/WhyNeedThis.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Core numbering](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/CoreNumbering.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU numbering (1)](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/GPUNumbering_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU numbering (2)](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/GPUNumbering_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU Numbering - Remarks](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/GPUNumberingRemarks.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Task distribution with Slurm](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/SlurmTaskDistribution_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Task distribution with Slurm (2)](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/SlurmTaskDistribution_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Task-to-CPU binding with Slurm](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/SlurmTaskCPU.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Task-to-CPU binding with Slurm: Masks](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/SlurmTaskCPUMasks.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Task-to-CPU binding with Slurm: Examples](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/SlurmTaskCPUExamples.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Task-to-GPU binding with Slurm](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/SlurmTaskGPU.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide MPI rank redistribution with Cray MPICH](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/MPICHRankRedistribution.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Refining core binding in OpenMP](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/OpenMPBinding.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Refining core binding in OpenMP: OMP_PLACES](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/OpenMPBindingPlaces.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Refining core binding in OpenMP: OMP_PROC_BIND](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/OpenMPBindingProcBind.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding with ROCR_VISIBLE_DEVICES](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRGPU.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Optimal mapping (1)](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRGPUMap_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Optimal mapping (2)](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRGPUMap_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Embedded rings](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRGPURing.png){ loading=lazy }
</figure>
...
["Introducing AMD CDNA(tm) 2 Architecture" whitepaper](https://www.amd.com/content/dam/amd/en/documents/instinct-business-docs/white-papers/amd-cdna2-white-paper.pdf).

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRMechanism.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Linear GCD, match CPU, no OpenMP](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRMechanismLinearGCD1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Linear GCD, match CPU, OpenMP](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRMechanismLinearGCD2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Linear CCD, match GCD, no OpenMP](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRMechanismLinearCCD1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Linear CCD, match GCD, OpenMP](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRMechanismLinearCCD2.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Linear CCD, match GCD, with cpus-per-task](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRMechanismLinearCCD3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Green ring, OpenMP, slide 1](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRMechanismGreenRing1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Green ring, OpenMP, slide 2](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRMechanismGreenRing2.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Implementation: Green ring, OpenMP, slide 3](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRMechanismGreenRing3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide GPU binding: Allocatable-by-resources partitions](https://462000265.lumidata.eu/2day-20241210/img/LUMI-2day-20241210-08-Binding/ROCRMechanismAllocateByResource.png){ loading=lazy }
</figure>
