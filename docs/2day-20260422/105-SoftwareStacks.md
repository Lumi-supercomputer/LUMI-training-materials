...
<figure markdown style="border: 1px solid #000">
  ![Software stack design considerations](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/SoftwareStacksDesignConsiderations.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![The LUMI solution](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/SoftwareStacksTheLUMISolution.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Policies](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/SoftwareStacksPolicies.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Organisation"Software Stacks](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/SoftwareStacksOrganisation.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Accessing the Cray PE on LUMI slide 1](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/SoftwareStacksAccessingCrayPE_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Accessing the Cray PE on LUMI slide 2](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/SoftwareStacksAccessingCrayPE_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Accessing the Cray PE on LUMI slide 3](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/SoftwareStacksAccessingCrayPE_3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Installing software on HPC systems](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildInstallingSoftwareHPC.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Extending the LUMI stack with EasyBuild](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildExtendingLUMIStack.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![EasyBuild recipes - easyconfigs](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildEasyConfig.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![The toolchain concept](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildToolchain_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![The toolchain concept 2](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildToolchain_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![easyconfig names and module names](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyConfigModuleNames.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Installing: Where to install](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildInstallingStep1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Installing: Configure the environment](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildInstallingStep2_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Step 2: Configure the environment - Demo](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildInstallingStep2_2.png){ loading=lazy }
</figure>
...
!!! Note "Results of the searches:"
    ...
    <figure markdown style="border: 1px solid #000">
      ![GROMACS in the LUMI Software Library](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSSoftLib.png){ loading=lazy }
    </figure>

    `eb --search GROMACS` produces:

    <figure markdown style="border: 1px solid #000">
      ![eb --search GROMACS](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSSearch_1.png){ loading=lazy }
    </figure>

    while `eb -S GROMACS` produces:

    <figure markdown style="border: 1px solid #000">
      ![eb -S GROMACS](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSSearch_2.png){ loading=lazy }
    </figure>
...
!!! Demo "The output of this command looks like:"
    ...
    <figure markdown style="border: 1px solid #000">
      ![eb GROMACS-2024.3-cpeGNU-24.03-PLUMED-2.9.4-noPython-CPU.eb –D](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSDep_01.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb GROMACS-2024.3-cpeGNU-24.03-PLUMED-2.9.4-noPython-CPU.eb –D (2)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSDep_02.png){ loading=lazy }
    </figure>
...
!!! Demo "Running EasyBuild to install GROMACS and dependency"
    ...
    <figure markdown style="border: 1px solid #000">
      ![eb GROMACS-2024.3-cpeGNU-25.03-PLUMED-2.9.4-noPython-CPU.eb -r](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSInst_01.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![eb GROMACS-2024.3-cpeGNU-25.03-PLUMED-2.9.4-noPython-CPU.eb -r (2)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSInst_02.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![eb GROMACS-2024.3-cpeGNU-2503-PLUMED-2.9.4-noPython-CPU.eb -r (3)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSInst_03.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb GROMACS-2024.3-cpeGNU-2503-PLUMED-2.9.4-noPython-CPU.eb -r (4)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSInst_04.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb GROMACS-2024.3-cpeGNU-2503-PLUMED-2.9.4-noPython-CPU.eb -r (5)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSInst_05.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb GROMACS-2024.3-cpeGNU-2503-PLUMED-2.9.4-noPython-CPU.eb -r (6)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildGROMACSInst_06.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Installing: Install the software](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildInstallingStep3Note.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![More advanced work](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildAdvanced_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![More advanced work (2): Repositories](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildAdvanced_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![More advanced work (3): Reproducibility](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildAdvanced_3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![EasyBuild tips and tricks](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildTipsTricks.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![EasyBuild training](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-105-SoftwareStacks/EasyBuildTraining.png){ loading=lazy }
</figure>
