...
MPI library yet. The latter is expected sometime in Q2 2026.
...
!!! Note "Currently missing in the system `rocm/6.3.4` module."
    ...
    that is more full-featured. See also [later sections in this course that 
...
versionless names after loading the corresponding `gcc-native` module.
...
simply called the versionless command names, which could be fixed by setting . 
