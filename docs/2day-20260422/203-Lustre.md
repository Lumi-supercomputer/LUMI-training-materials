...
<figure markdown style="border: 1px solid #000">
  ![File systems on LUMI](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/FileSystemLumi.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Lustre building blocks](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreBuildingBlocks1_1_separation.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Lustre building blocks (2)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreBuildingBlocks2.png){ loading=lazy }
</figure>
...
1.  **Metadata servers (MDSes)**
    ...
    <figure markdown style="border: 1px solid #000">
      ![Lustre building blocks -oss](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreBuildingBlocks1_2_MDS.png){ loading=lazy }
    </figure>
...
2.  **Object storage servers (OSSes)**
    ...
    <figure markdown style="border: 1px solid #000">
      ![Lustre building blocks -oss](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreBuildingBlocks1_3_OSS.png){ loading=lazy }
    </figure>
...
3.  **Lustre clients**
    ...
    <figure markdown style="border: 1px solid #000">
      ![Lustre building blocks -oss](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreBuildingBlocks1_4_client.png){ loading=lazy }
    </figure>
...
4.  **High-performance interconnect**
    ...
    <figure markdown style="border: 1px solid #000">
      ![Lustre building blocks -oss](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreBuildingBlocks1_5_network.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Large files are spread across OSTs](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreFileStriping.png){ loading=lazy }
</figure>
...
1.  The first step is opening the file. 
    ...
    <figure markdown style="border: 1px solid #000">
      ![Accessing: Query MDS](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreFileAccess_1_queryMDS.png){ loading=lazy }
    </figure>
...
2.  MDS answers:
    ...
    <figure markdown style="border: 1px solid #000">
      ![Accessing: Return MDS](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreFileAccess_2_returnMDS.png){ loading=lazy }
    </figure>
...
3.  Data access:
    ...
    <figure markdown style="border: 1px solid #000">
      ![Accessing: Write to OSS](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreFileAccess_3_writeOSS.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Parallelism is key! (slide 1)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreParallelismKey_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Parallelism is key! (slide 2)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreParallelismKey_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![How to determine the striping values?](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreDetermineParameters.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (1)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreManageStriping1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (2)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreManageStriping2_0_full.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (3)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreManageStriping3.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (4)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreManageStriping4.png){ loading=lazy }
</figure>
...
```
$ module use /appl/local/training/modules/2day-20250422
...
<figure markdown style="border: 1px solid #000">
  ![The metadata servers (1)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreMDS_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![The metadata servers (2)](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LustreMDS_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Lustre on LUMI](https://462000265.lumidata.eu/2day-20260422/img/LUMI-2day-20260422-203-Lustre/LumiLustreOnLumi.png){ loading=lazy }
</figure>
