...
personal directory in the `project_465003358` directory, e.g., to
`/scratch/project_465003358/$USER`.
-->
...
-   See the exercise assignments in
    `/project/project_465003358/Exercises/HPE/01_intro/README.md`

-   Exercise materials in 
    `/project/project_465003358/Exercises/HPE/01_intro` 
