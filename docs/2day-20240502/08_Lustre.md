...
<figure markdown style="border: 1px solid #000">
  ![File systems on LUMI](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/FileSystemLumi.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Lustre building blocks](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LustreBuildingBlocks1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Lustre building blocks (2)](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LustreBuildingBlocks2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Large files are spread across OSTs](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LustreFileStriping.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Accessing a file](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LustreFileAccess.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Parallelism is key! (slide 1)](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LustreParallelismKey_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Parallelism is key! (slide 2)](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LustreParallelismKey_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![How to determine the striping values?](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LustreDetermineParameters.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (1)](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LustreManageStriping1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (3)](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LustreManageStriping3.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (4)](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LustreManageStriping4.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Lustre on LUMI](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LumiLustreOnLumi.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Storage areas](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LumiStorageAreas.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Object storage: LUMI-O](https://462000265.lumidata.eu/2day-20240502/img/LUMI-2day-20240502-08-lustre/LumiObjectStorage.png){ loading=lazy }
</figure>
