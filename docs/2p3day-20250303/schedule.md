...
-->
    ...
    <tr>
        ...
        <td><b><a href="../M304-Offload_CCE/">OpenACC and OpenMP offload with Cray Compilation Environment, and frameworks for porting applications</a></b>
...
-->
    ...
    <tr>
        ...
        <br/><em>Presenters: Thierry Braconnier and Alfio Lazarro (HPE)</em>
        <ul>
    ...
    <tr>
        ...
        <br/><em>Presenters: Thierry Braconnier and Alfo Lazarro (HPE)</em>
        <ul>
...
-->
    ...
    <tr>
        ...
        <td><b><a href="../M501-Porting_to_GPU/">GPU Application Porting Strategies</a></b>
        <br/><em>Presenter: Alfio Lazarro (HPE)</em>
        <ul>
            <li/>Strategies for porting to GPUs
        </ul>
        </td>
    </tr>
    <tr>
        ...
        <td><b><a href="../M502-Introduction_to_Python_on_Cray_EX/">Introduction to Python on Cray EX</a></b>
        <br/><em>Presenter: Jean Pourroy (HPE)</em>
        <ul>
