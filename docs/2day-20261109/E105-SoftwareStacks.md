...
in `/scratch/project_465003355/$USER/eb-course` if you make the exercises during the course.
...
-   Set `EBU_USER_PREFIX`: 
    ...
    ```
    export EBU_USER_PREFIX=/scratch/project_465003355/$USER/eb-course
    ```
...
-   At the end, when you don't need the software installation anymore, you can simply remove the directory
    ...
    ```
    rm -rf /scratch/project_465003355/$USER/eb-course
    ```
