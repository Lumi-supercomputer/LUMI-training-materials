...
<figure markdown style="border: 1px solid #000">
  ![Slide Why know...](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/WhyKnow.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide What is LUMI-O (1)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOWhatIs_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide What is LUMI-O (2)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOWhatIs_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Lustre vs LUMI-O (1)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LustreVsLUMIO_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Lustre vs LUMI-O (2)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LustreVsLUMIO_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Lustre vs LUMI-O (3)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LustreVsLUMIO_3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Accessing LUMI-O](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOAccessing.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Credential management web interface](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialWebOverview.png){ loading=lazy }
</figure>
...
!!! Demo "A walk through the credentials management web interface of LUMI-O"
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management web interface (1)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsWebCreate_01.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management web interface (2)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsWebCreate_02.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management web interface (3)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsWebCreate_03.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management web interface (4)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsWebCreate_04.png){ loading=lazy }
    </figure>

    Now click on the key to get more information about the key: 

    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management web interface: Check credentials](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsWebCheck.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management web interface: Extending the life span of a key](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsWebExtend.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management web interface: Configuring tools (1)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsWebToolConfig_01.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management web interface: Configuring tools (2)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsWebToolConfig_02.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Credentials management through Open OnDemand Overview](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsOODOverview.png){ loading=lazy }
</figure>
...
!!! Demo "A walk through the Open OnDemand web interface to LUMI-O"
    *This demo was made with a project that course participants have no access to,
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management through Open OnDemand (1)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsOODCreate_01.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management through Open OnDemand (2)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsOODCreate_02.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management through Open OnDemand (3)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsOODCreate_03.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management through Open OnDemand (4)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsOODCreate_04.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Credentials management through Open OnDemand (5)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsOODCreate_05.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Browsing through Open OnDemand (1)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsOODBrowse_01.png){ loading=lazy }
    </figure>
    ...
    **Note: The screenshots are inconsistent as now we proceed with the 465000095 project.**
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Browsing through Open OnDemand (2)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsOODBrowse_02.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Browsing through Open OnDemand (3)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsOODBrowse_03.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Slide Browsing through Open OnDemand (4)](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCredentialsOODBrowse_04.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Configuring LUMI-O tools](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCLIToolConfig.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide rclone on LUMI-O](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/LUMIOCLIToolConfigRcloneS3cmd.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Bucket and object names](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/BucketObjectNames.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Policies and ACLs](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/PoliciesACLs.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Policies and ACLs: Examples](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/PoliciesACLsExamples.png){ loading=lazy }
</figure>
...
3.  Checking the current ACLs and more of an object, can also be done with the `s3cmd` command.
    ...
    -   A bucket used to serve the images on this page:
        ...
        ```
        s3cmd info s3://2day-20261109
        ```

        produces

        ```
        s3://2day-20261109/ (bucket):
          Location:  lumi-prod
          Payer:     BucketOwner
          Ownership: none
          Versioning:none
          ...
          URL:       http://lumidata.eu/2day-20261109/
        ```
    ...
    -   An example of an object in that bucket:
        ...
        ```
        s3cmd info s3://2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/Title.png
        ```

        where the output shows again that this is a public object:

        ```
        s3://2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/Title.png (object):
          File size: 4384337
          ...
          ACL:       *anon*: READ
          ACL:       LUMI training material: FULL_CONTROL
          URL:       http://lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/Title.png
    ...
    -   However, if you try
        ...
        [https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/Title.png](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/Title.png)
        or
        [https://lumidata.eu/462000265:2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/Title.png](https://lumidata.eu/462000265:2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/Title.png)
...
<figure markdown style="border: 1px solid #000">
  ![Slide Sharing data](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/SharingData.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Slide Sharing data: Pre-signed URLs](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/SharingDataPresignedURL.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Slide Tips & tricks](https://462000265.lumidata.eu/2day-20261109/img/LUMI-2day-20261109-204-ObjectStorage/TipsAndTricks_01.png){ loading=lazy }
</figure>
