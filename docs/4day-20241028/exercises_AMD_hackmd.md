# LUMI Training - Amsterdam, Nederlands (October 2024)
...
<!-- * Execute dynamic instrumentation: `time srun -n 1 -c 7 --gpus 1 omnitrace-instrument -- ./Jacobi_hip -g 1 1` and check the duration (may fail?) -->
