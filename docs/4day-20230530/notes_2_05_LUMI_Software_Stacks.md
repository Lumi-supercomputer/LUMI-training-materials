...
<figure markdown style="border: 1px solid #000">
  ![What this talk is about](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Design consideration](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia3.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![The LUMI solution](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia4.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Software policies](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia5.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Organisation: Software stacks](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia6.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Accessing the Cray PE: BAre and CrayEnv](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia7.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Accessing the Cray PE: LUMI stack](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia8.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![The LUMI software stack](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia9.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Exploring modules with Lmod](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia10.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![module spider](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia11.png){ loading=lazy }
</figure>
...
2.  `module spider` with the name of a package will show all versions of that package installed on
    ...
    Now try `module spider CMake`. We see that there are four versions,3.22.2, 3.23.2, 3.24.0 and 3.25.2, 
    ...
    There are also a couple of regular modules called `cmake` that come from software installed
    differently.

3.  The third use of `module spider` is with the full name of a module. Try for instance
    `module spider gnuplot/5.4.6-cpeGNU-22.12`. This will now show full help information for
    the specific module, including what should be done to make the module available. For 
    this GNUplot module we see that there are three ways to load the module: By loading `LUMI/22.12` 
    combined with `partition/C`, by loading `LUMI/22.12` combined with `partition/G`
    or by loading `LUMI/22.12` combined with `partition/L`. So use only
    a single line, but chose it in function of the other modules that you will also need. In this case
    it means that that version of GNUplot is available in the `LUMI/22.12` stack which we could already
    ...
    `module spider CMake/3.25.2`. This will now show us that this tool is in the `buildtools/22.12`
    module (among others) and give us 4 different options to load that module as it is provided in the `CrayEnv`
    and the `LUMI/22.12` software stacks and for all partitions (basically because we don't do
...
???+Demo "Demo module spider"
    ...
    <figure markdown style="border: 1px solid #000">
      ![module spider demo slide 1](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia12.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module spider demo slide 2](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia13.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module spider demo slide 3](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia14.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module spider demo slide 4](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia15.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module spider demo slide 5](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia16.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module spider demo slide 6](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia17.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module spider demo slide 7](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia18.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module spider demo slide 8](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia19.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module spider demo slide 9](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia20.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module spider demo slide 10](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia21.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![module keyword command](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia22.png){ loading=lazy }
</figure>
...
???+Demo "Demo module keyword"
    ...
    <figure markdown style="border: 1px solid #000">
      ![module keyword demo slide 1](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia23.png){ loading=lazy }
    </figure>

    The bug in the Lmod 8.3 version on LUMI is that all extensions are shown in the output 
    while they are irrelevant. 

    <figure markdown style="border: 1px solid #000">
      ![module keyword demo slide 2](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia24.png){ loading=lazy }
    </figure>

    On the second screen though we see `cURL` which is a tool to download files over,
    among others, https.

    <figure markdown style="border: 1px solid #000">
      ![module keyword demo slide 3](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia25.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module keyword demo slide 4](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia26.png){ loading=lazy }
    </figure>

    And the fourth screen `wget` which is also a tool to download files from the internet
    over an https connection.

    <figure markdown style="border: 1px solid #000">
      ![module keyword demo slide 4](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia27.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Sticky modules and module purge](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia28.png){ loading=lazy }
</figure>
...
???+Demo "Demo"
    ...
    <figure markdown style="border: 1px solid #000">
      ![module av slide 1](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia29.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![module av slide 2](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia30.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![module av slide 3](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia31.png){ loading=lazy }
    </figure>

    In the next screen we see the modules for the software stack that we have just discussed.

    <figure markdown style="border: 1px solid #000">
      ![module av slide 4](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia32.png){ loading=lazy }
    </figure>

    And the screen below shows the extensions of modules (like the CMake tool we've tried to locate
    before)

    <figure markdown style="border: 1px solid #000">
      ![module av slide 4](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia33.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![module av slide 4](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia34.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Changing how the module list is displayed](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia35.png){ loading=lazy }
</figure>
...
users or not useful in the context you're in at the moment. For instance, when working in the `LUMI/22.12`
...
<figure markdown style="border: 1px solid #000">
  ![Installing software on HPC systems](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia36.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Extending the LUMI stack with EasyBuild](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia37.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![EasyBuild recipes - easyconfigs](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia38.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![The toolchain concept](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia39.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![The toolchain concept 2](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia40.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![easyconfig names and module names](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia41.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Step 1: Where to install](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia42.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Step 2: Configure the environment](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia43.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Step 2: Configure the environment - Demo](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia44.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Step 3: Install the software](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia45.png){ loading=lazy }
</figure>
...
???+demo "Demo of the EasyBuild installation of GROMACS"
    ...
    <figure markdown style="border: 1px solid #000">
      ![eb --search](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia46.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb -S](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia47.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb -D](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia48.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb -D](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia49.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb -r](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia50.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb -r](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia51.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb -r](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia52.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb -r](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia53.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb -r](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia54.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![eb -r](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia55.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Step 3: Install the software - Note](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia56.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![More advanced work](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia57.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![More advanced work (2)](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia58.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![More advanced work (3)](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia59.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![EasyBuild additional tips&tricks](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia60.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![EasyBuild training](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia61.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Containers on LUMI](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia62.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![What do containers not provide](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia63.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![But what can they then do on LUMI?](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia64.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing containers](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia65.png){ loading=lazy }
</figure>
...
???+demo "Demo singularity pull"
    ...
    <figure markdown style="border: 1px solid #000">
      ![Demo singularity pull slide 1](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia66.png){ loading=lazy }
    </figure>

    We do get a lot of warnings but usually this is perfectly normal and usually they can be safely ignored.

    <figure markdown style="border: 1px solid #000">
      ![Demo singularity pull slide 2](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia67.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![Demo singularity pull slide 3](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia68.png){ loading=lazy }
    </figure>


<figure markdown style="border: 1px solid #000">
  ![Managing containers (2)](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia69.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Interacting with containers](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia70.png){ loading=lazy }
</figure>
...
???+demo "Demo singularity shell"
    ...
    <figure markdown style="border: 1px solid #000">
      ![Demo singularity shell](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia71.png){ loading=lazy }
    </figure>
...
???+demo "Demo singularity exec"
    ...
    <figure markdown style="border: 1px solid #000">
      ![Demo singularity exec](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia72.png){ loading=lazy }
    </figure>
...
???+demo "Demo singularity run"
    ...
    <figure markdown style="border: 1px solid #000">
      ![Demo singularity run](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia73.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![/running containers on LUMI](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia74.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Environment enhancements](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia75.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Environment enhancements (2)](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia76.png){ loading=lazy }
</figure>
...
???+demo "Demo lumi-container-wrapper"
    ...
    <figure markdown style="border: 1px solid #000">
      ![demo lumi-container-wrapper slide 1](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia77.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![demo lumi-container-wrapper slide 2](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia78.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![demo lumi-container-wrapper slide 3](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia79.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![demo lumi-container-wrapper slide 4](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia80.png){ loading=lazy }
    </figure>

    <figure markdown style="border: 1px solid #000">
      ![demo lumi-container-wrapper slide 65](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia81.png){ loading=lazy }
    </figure>
    ...
    <figure markdown style="border: 1px solid #000">
      ![demo lumi-container-wrapper slide 6](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia82.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![Container limitations on LUMI](https://462000265.lumidata.eu/4day-20230530/img/LUMI-4day-20230530-software/Dia83.png){ loading=lazy }
</figure>
