...
<figure markdown style="border: 1px solid #000">
  ![File systems on LUMI](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/FileSystemLumi.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Lustre building blocks](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreBuildingBlocks1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Lustre building blocks (2)](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreBuildingBlocks2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Large files are spread across OSTs](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreFileStriping.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Accessing a file](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreFileAccess.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Parallelism is key! (slide 1)](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreParallelismKey_1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Parallelism is key! (slide 2)](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreParallelismKey_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![How to determine the striping values?](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreDetermineParameters.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (1)](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreManageStriping1.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (2)](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreManageStriping2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (3)](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreManageStriping3.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Managing the striping parameters (4)](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreManageStriping4.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![The metadata servers (1)](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreMDS_1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![The metadata servers (2)](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LustreMDS_2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Lustre on LUMI](https://462000265.lumidata.eu/2day-20250602/img/LUMI-2day-20250602-203-Lustre/LumiLustreOnLumi.png){ loading=lazy }
</figure>
