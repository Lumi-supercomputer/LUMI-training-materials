...
<figure markdown style="border: 1px solid #000">
  ![Distributed nature of support (1)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/DistributedNature1.png){ loading=lazy }
</figure>

<!-- BELGIUM
<figure markdown style="border: 1px solid #000">
  ![Distributed nature of support (2)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/DistributedNature2.png){ loading=lazy }
</figure>
-->
...
<figure markdown style="border: 1px solid #000">
  ![L0 support: Take a training!](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/L0Training.png){ loading=lazy }
</figure>
...
1.  The [main documentation at docs.lumi-supercomputer.eu](https://docs.lumi-supercomputer.eu/)
    ...
    <figure markdown style="border: 1px solid #000">
      ![L0 support: Check the docs! (1)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/L0ReadTheDocs1.png){ loading=lazy }
    </figure>
...
2.  The [LUMI Software Library](https://lumi-supercomputer.github.io/LUMI-EasyBuild-docs/) contains
    ...
    <figure markdown style="border: 1px solid #000">
      ![L0 support: Check the docs! (3)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/L0ReadTheDocs3.png){ loading=lazy }
    </figure>
...
1.  Search in the [main documentation at docs.lumi-supercomputer.eu](https://docs.lumi-supercomputer.eu/) 
    ...
    <figure markdown style="border: 1px solid #000">
      ![L0 support: Check the docs! (2)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/L0ReadTheDocs2.png){ loading=lazy }
    </figure>
...
2.  Users of the Finnish national systems have been told to use a tool called "Tykky"
    ...
    <figure markdown style="border: 1px solid #000">
      ![L0 support: Check the docs! (4)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/L0ReadTheDocs4.png){ loading=lazy }
    </figure>
...
3.  Try searching for the `htop` command in the 
    ...
    <figure markdown style="border: 1px solid #000">
      ![L0 support: Check the docs! (5)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/L0ReadTheDocs5.png){ loading=lazy }
    </figure>
...
<figure markdown style="border: 1px solid #000">
  ![L0 support: Talk to your colleagues](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/L0Colleagues.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![L1 and basic L2: LUST (1)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/LUST1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![L1 and basic L2: LUST (2)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/LUST2.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![L1 and basic L2: LUST (3)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/LUST3.png){ loading=lazy }
</figure>
...
The LUMI help desk is staffed from Monday till Friday between 9am and 7pm Helsinki time (EE(S)T) except on public holidays
...
<figure markdown style="border: 1px solid #000">
  ![How not to write a ticket](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/TicketsHowNot.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Improved version login ticket](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/TicketsImprovedLogin.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![1 ticket = 1 issue = 1 ticket](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/Tickets1issue1ticket.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Subject line is important](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/TicketsSubject.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Think with us (1)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/TicketsThinkWithUs1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![Think with us (2)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/TicketsThinkWithUs2.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![Beware of the XY-problem](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/TicketsXY.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![help desk restrictions](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/HelpdeskRestrictions.png){ loading=lazy }
</figure>
...
<figure markdown style="border: 1px solid #000">
  ![What support can and cannot do (1)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/HelpdeskCanCannot1.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![What support can and cannot do (2)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/HelpdeskCanCannot2.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![What support can and cannot do (3)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/HelpdeskCanCannot3.png){ loading=lazy }
</figure>

<figure markdown style="border: 1px solid #000">
  ![What support can and cannot do (4)](https://462000265.lumidata.eu/4day-20240423/img/LUMI-4day-20240423-support/HelpdeskCanCannot4.png){ loading=lazy }
</figure>
...
-   These course notes also contain a
    [page with links into technical documentation](A01_Documentation.md)
